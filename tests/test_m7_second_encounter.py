...
class M7SecondEncounterContentTests(unittest.TestCase):
    ...
    def test_pack_has_the_second_original_encounter_without_new_mechanics(self) -> None:
        self.assertEqual(self.pack.version, "0.7.0")
        self.assertEqual(len(self.pack.rooms), 4)
        self.assertEqual(len(self.pack.monsters), 2)
        self.assertEqual(len(self.pack.quests), 5)
    ...
    def test_v7_rejects_a_save_from_the_old_0_6_content_pack(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            self.assertIn('"version": "0.7.0"', save_text)
