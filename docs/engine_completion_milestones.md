...
_Last updated: 2026-07-29（M6 已由 GPT-5.6-sol 独立验收 GO；M7.1 已本地实现，等待独立验收）_
...
- **状态**: M7.1 第二个原创遭遇已由 Codex 本地实现并验证；等待 GPT-5.6-sol 独立验收，
  不得表述为 M7 GO。
...
- **强制完成条件** — original_demo 至少达到：
  ...
  - 至少一个可实际买卖的商店。
  - 至少一个可复现的死亡/恢复流程。
- 内容扩容队列第一步已由 M7.1 实现；任何下一项 M7 扩容仍须在 M7.1 独立验收 GO 后获得
  项目负责人单独授权，不得成为 M2。
