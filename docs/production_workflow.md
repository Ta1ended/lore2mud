# GPT-5.6-sol 顾问与 Hermes agent 执行工作流

## 角色分工

GPT-5.6-sol 负责范围、数据契约、架构边界、风险和独立验收。Hermes agent
负责在仓库内完成一个经确认的纵向切片、场景测试、文档和交接。
...
请先报告数据流、文件范围、状态/兼容风险和测试计划。经确认后由 Hermes agent
