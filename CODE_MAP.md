...
| `src/lore2mud/engine/commands.py` | 1082 | CLI parsing and `TurnResult` text rendering. | Legacy routing compatibility remains broad. |
...
| `src/lore2mud/application/session.py` | 638 | Turn coordination and transaction boundary. | Projection rollback uses whole-World copies. |
