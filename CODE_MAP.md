...
| `src/lore2mud/engine/commands.py` | 1080 | CLI parsing and `TurnResult` text rendering. | Legacy routing compatibility remains broad. |
| `src/lore2mud/application/contracts.py` | 666 | Typed V2-1 request/result/view/event values. | Current closed action set is V1-specific. |
| `src/lore2mud/application/session.py` | 606 | Turn coordination and transaction boundary. | Projection rollback uses whole-World copies. |
| `src/lore2mud/web/app.py` | 547 | Web parsing and JSON compatibility rendering. | Legacy and V2 response shapes coexist. |
